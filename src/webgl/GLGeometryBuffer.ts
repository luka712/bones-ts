import { GeometryBuffer, ComponentType, IndicesBufferDescription, SharedVertexBufferDescription, VertexBufferDescription, DrawType } from "../framework/GeometryBuffer";
...
export class GLGeometryBuffer implements GeometryBuffer
{
     ...
     */
    constructor(private m_gl: WebGL2RenderingContext, vertices_attr: Array<VertexBufferDescription> = null, indices_attr: IndicesBufferDescription = null, shared_buffer: SharedVertexBufferDescription = null)
    {
        ...
        if (!shared_buffer)
        {
            this.m_vaoId = this.m_gl.createVertexArray();
            this.bind();
            ...
            {
                const id = this.m_gl.createBuffer();

                this.m_gl.bindBuffer(this.m_gl.ARRAY_BUFFER, id);
                this.m_gl.bufferData(this.m_gl.ARRAY_BUFFER, attr.data, attr.bufferUsage);
